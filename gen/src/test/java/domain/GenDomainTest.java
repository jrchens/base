...
public class GenDomainTest {
    private final static Logger logger = LoggerFactory.getLogger(GenDomainTest.class);
...
//            }
        ...
        Template t = ve.getTemplate("vm/domain-test.vm");
        t.merge(context, writer);

        // System.out.println(writer.toString());
        Files.write(writer.toString(),new File("/Users/shengchen/Documents/Temporary/"+className+".java"), Charsets.UTF_8);
    }
}
