...
<table id="admin_role_detail_user_datagrid" class="easyui-datagrid"
       data-options="title: '用户列表',
            url: 'http://local.com/admin/user-role-relation/user/async-user-query',
            method: 'get',
            ...
            <%--onClickRow: function(index,row){--%>
                <%--if(row.def){--%>
                    <%--$('#admin_role_detail_user_datagrid_delete').linkbutton('disable');--%>
                    <%--$('#admin_role_detail_user_datagrid_tag').linkbutton('disable');--%>
                <%--}else{--%>
                    <%--$('#admin_role_detail_user_datagrid_delete').linkbutton('enable');--%>
                    <%--$('#admin_role_detail_user_datagrid_tag').linkbutton('enable');--%>
                <%--}--%>
            <%--},--%>
            <%--toolbar: [--%>
                        ...
                        <%--},--%>
                        <%--{--%>
                            <%--id: 'admin_role_detail_user_datagrid_delete',--%>
                            <%--iconCls:'ext-icon fa fa-trash',--%>
                            <%--handler:function(){--%>
                                <%--var thisButton = $(this);--%>
                                <%--var row = $('#admin_role_detail_user_datagrid').datagrid('getSelected');--%>
                                <%--if(row == null){--%>
                                ...
                                <%--$.messager.confirm('确认', '确认删除记录吗?', function(r) {--%>
                                    <%--if (r) {--%>
                                        ...
                                        <%--$.post('http://local.com/admin/user-role-relation/user/async-delete',reqData,function(data,textStatus,jqXHR){--%>
                                            <%--if(data.success){--%>
                                                <%--$('#admin_role_detail_user_datagrid').datagrid('reload');--%>
                                            <%--}else{--%>
                                                <%--$.messager.show({msg:data.message});--%>
                                            <%--}--%>
                                        <%--},'json').always(function(data_jqXHR, textStatus, jqXHR_errorThrown){--%>
                        ...
                        <%--},--%>
                        <%--{--%>
                            <%--id: 'admin_role_detail_user_datagrid_tag',--%>
